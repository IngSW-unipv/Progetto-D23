...
CREATE SCHEMA IF NOT EXISTS hospitalmanager;
USE hospitalmanager;
...
CREATE TABLE PROFILI (
    CF VARCHAR(16),
	TIPO VARCHAR(5), -- CHECK (TIPO = 'ME' OR TIPO = 'OS' OR TIPO = 'OU' OR TIPO = 'PA'),
	PW VARCHAR(20),
    SPECIALIZZAZIONE VARCHAR(100),
    
	NOME VARCHAR(50),
	COGNOME VARCHAR(50),
	SESSO VARCHAR(5), -- CHECK (SESSO = 'M' OR SESSO = 'F'),
...
CREATE TABLE PRENOTAZIONI (
	...
	PAZIENTE VARCHAR(16),
	PERSONALE_SANITARIO VARCHAR(16),
...
INSERT INTO PRESTAZIONI_SANITARIE VALUES ('NULL', '00:00:00.000000');
END//
mysql> delimiter ;
...
INSERT INTO PROFILI VALUES ('AVWX123456789012', 'PA', 'ProtectedPW!', NULL, 'Davide', 'Rossini', 'M', '1977-11-28', 'Bologna', 'BO', 'Emilia-Romagna', 'BO', 'Bologna', 'Via Bologna 78', '40100', 'davide.rossini@email.com', '7890123456');
INSERT INTO PROFILI VALUES ('XZAB567890123456', 'PA', 'SafePass987', NULL, 'Elena', 'Ferrara', 'F', '1986-06-14', 'Genova', 'GE', 'Liguria', 'GE', 'Genova', 'Via Genova 89', '16100', 'elena.ferrara@email.com', '8901234567');
INSERT INTO PROFILI VALUES ('TDEF901234567890', 'PA', 'TopSecretPW', NULL, 'Roberto', 'Sanna', 'M', '1999-11-20', 'Bari', 'BA', 'Puglia', 'BA', 'Bari', 'Via Bari 90', '70100', 'roberto.sanna@email.com', '9012345678');
...
INSERT INTO CARTELLE_CLINICHE VALUES ('AVWX123456789012', '182', '78', 'ZERO_NEGATIVO');
INSERT INTO CARTELLE_CLINICHE VALUES ('XZAB567890123456', '163', '58', 'A_NEGATIVO');
INSERT INTO CARTELLE_CLINICHE VALUES ('TDEF901234567890', '170', '68', 'A_POSITIVO');
...
INSERT INTO PRENOTAZIONI VALUES ('1000', 'GHIJ345678901234', 'ABCD123456789012', 'VISITA_ONCOLOGICA', '2023-10-01', '07:00:00.000000');
INSERT INTO PRENOTAZIONI VALUES ('1001', 'KLMN678901234567', 'EFGH789012345678', 'VISITA_PSICOLOGICA', '2023-10-01', '08:00:00.000000');
INSERT INTO PRENOTAZIONI VALUES ('1002', 'ABCD567890123456', 'IJKL567890123456', 'ESAMI_SANGUE', '2023-10-01', '08:00:00.000000');
INSERT INTO PRENOTAZIONI VALUES ('1003', 'EFGH901234567890', 'MNOP234567890123', 'TAC', '2023-10-01', '10:00:00.000000');
INSERT INTO PRENOTAZIONI VALUES ('1004', 'IJKL123456789012', 'QRST890123456789', 'RISONANZA_MAGNETICA', '2023-10-01', '10:00:00.000000');
INSERT INTO PRENOTAZIONI VALUES ('1005', 'MNOP567890123456', 'UVWX123456789012', 'CHEMIOTERAPIA', '2023-10-01', '11:00:00.000000');
INSERT INTO PRENOTAZIONI VALUES ('1006', 'QRST901234567890', 'YZAB567890123456', 'RADIOTERAPIA', '2023-10-01', '11:00:00.000000');
INSERT INTO PRENOTAZIONI VALUES ('1007', 'AVWX123456789012', 'ABCD123456789012', 'VISITA_ONCOLOGICA', '2023-10-01', '09:00:00.000000');
INSERT INTO PRENOTAZIONI VALUES ('1008', 'XZAB567890123456', 'EFGH789012345678', 'VISITA_PSICOLOGICA', '2023-10-01', '09:00:00.000000');
INSERT INTO PRENOTAZIONI VALUES ('1009', 'TDEF901234567890', 'IJKL567890123456', 'ESAMI_SANGUE', '2023-10-01', '16:00:00.000000');

INSERT INTO PRENOTAZIONI VALUES ('1010', 'GHIJ345678901234', 'ABCD123456789012', 'VISITA_ONCOLOGICA', '2023-12-01', '07:00:00.000000');
INSERT INTO PRENOTAZIONI VALUES ('1011', 'KLMN678901234567', 'EFGH789012345678', 'VISITA_PSICOLOGICA', '2023-12-01', '08:00:00.000000');
INSERT INTO PRENOTAZIONI VALUES ('1012', 'ABCD567890123456', 'IJKL567890123456', 'ESAMI_SANGUE', '2023-12-01', '08:00:00.000000');
INSERT INTO PRENOTAZIONI VALUES ('1013', 'EFGH901234567890', 'MNOP234567890123', 'TAC', '2023-12-01', '10:00:00.000000');
INSERT INTO PRENOTAZIONI VALUES ('1014', 'IJKL123456789012', 'QRST890123456789', 'RISONANZA_MAGNETICA', '2023-12-01', '10:00:00.000000');
INSERT INTO PRENOTAZIONI VALUES ('1015', 'MNOP567890123456', 'UVWX123456789012', 'CHEMIOTERAPIA', '2023-12-01', '11:00:00.000000');
INSERT INTO PRENOTAZIONI VALUES ('1016', 'QRST901234567890', 'YZAB567890123456', 'RADIOTERAPIA', '2023-12-01', '11:00:00.000000');
INSERT INTO PRENOTAZIONI VALUES ('1017', 'AVWX123456789012', 'ABCD123456789012', 'VISITA_ONCOLOGICA', '2023-12-01', '09:00:00.000000');
INSERT INTO PRENOTAZIONI VALUES ('1018', 'XZAB567890123456', 'EFGH789012345678', 'VISITA_PSICOLOGICA', '2023-12-01', '09:00:00.000000');
INSERT INTO PRENOTAZIONI VALUES ('1019', 'TDEF901234567890', 'IJKL567890123456', 'ESAMI_SANGUE', '2023-12-01', '16:00:00.000000');

INSERT INTO PRENOTAZIONI VALUES ('1020', 'AVWX123456789012', 'ABCD123456789012', 'VISITA_ONCOLOGICA', '2023-12-12', '07:00:00.000000');
INSERT INTO PRENOTAZIONI VALUES ('1021', 'XZAB567890123456', 'EFGH789012345678', 'VISITA_PSICOLOGICA', '2023-12-12', '08:00:00.000000');
INSERT INTO PRENOTAZIONI VALUES ('1022', 'TDEF901234567890', 'IJKL567890123456', 'ESAMI_SANGUE', '2023-12-13', '16:00:00.000000');
INSERT INTO PRENOTAZIONI VALUES ('1023', 'GHIJ567890123456', 'MNOP234567890123', 'TAC', '2023-12-13', '14:00:00.000000');
INSERT INTO PRENOTAZIONI VALUES ('1024', 'KLMN901234567890', 'QRST890123456789', 'RISONANZA_MAGNETICA', '2023-12-13', '11:00:00.000000');
INSERT INTO PRENOTAZIONI VALUES ('1025', 'GHIJ345678901234', 'UVWX123456789012', 'CHEMIOTERAPIA', '2023-12-13', '18:00:00.000000');
INSERT INTO PRENOTAZIONI VALUES ('1026', 'KLMN678901234567', 'YZAB567890123456', 'RADIOTERAPIA', '2023-12-14', '18:00:00.000000');

INSERT INTO PRENOTAZIONI VALUES ('1027', 'ABCD567890123456', 'ABCD123456789012', 'VISITA_ONCOLOGICA', '2023-12-15', '15:00:00.000000');
INSERT INTO PRENOTAZIONI VALUES ('1028', 'EFGH901234567890', 'EFGH789012345678', 'VISITA_PSICOLOGICA', '2023-12-15', '08:00:00.000000');
INSERT INTO PRENOTAZIONI VALUES ('1029', 'IJKL123456789012', 'IJKL567890123456', 'ESAMI_SANGUE', '2023-12-15', '09:00:00.000000');
INSERT INTO PRENOTAZIONI VALUES ('1030', 'MNOP567890123456', 'MNOP234567890123', 'TAC', '2023-12-15', '17:00:00.000000');
INSERT INTO PRENOTAZIONI VALUES ('1031', 'QRST901234567890', 'QRST890123456789', 'RISONANZA_MAGNETICA', '2023-12-15', '07:00:00.000000');
INSERT INTO PRENOTAZIONI VALUES ('1032', 'AVWX123456789012', 'UVWX123456789012', 'CHEMIOTERAPIA', '2023-12-15', '18:00:00.000000');
INSERT INTO PRENOTAZIONI VALUES ('1033', 'XZAB567890123456', 'YZAB567890123456', 'RADIOTERAPIA', '2023-12-15', '18:00:00.000000');
END//
mysql> delimiter ;
...
CREATE VIEW CALENDARIO_VISITA_ONCOLOGICA 
AS SELECT CALENDARIO_DATA, GIORNO_SETTIMANA, NOME_VACANZE, ORARIO, VISITA_ONCOLOGICA
FROM CALENDARI 
WHERE VISITA_ONCOLOGICA IS NULL AND NOME_VACANZE IS NULL AND GIORNO_SETTIMANA <> 'Domenica' 
ORDER BY CALENDARIO_DATA LIMIT 0, 200;

CREATE VIEW CALENDARIO_VISITA_PSICOLOGICA 
AS SELECT CALENDARIO_DATA, GIORNO_SETTIMANA, NOME_VACANZE, ORARIO, VISITA_PSICOLOGICA
FROM CALENDARI 
WHERE VISITA_PSICOLOGICA IS NULL AND NOME_VACANZE IS NULL AND GIORNO_SETTIMANA <> 'Domenica' 
ORDER BY CALENDARIO_DATA LIMIT 0, 200;

CREATE VIEW CALENDARIO_ESAMI_SANGUE 
AS SELECT CALENDARIO_DATA, GIORNO_SETTIMANA, NOME_VACANZE, ORARIO, ESAMI_SANGUE
FROM CALENDARI 
WHERE ESAMI_SANGUE IS NULL AND NOME_VACANZE IS NULL AND GIORNO_SETTIMANA <> 'Domenica' 
ORDER BY CALENDARIO_DATA LIMIT 0, 200;

CREATE VIEW CALENDARIO_TAC 
AS SELECT CALENDARIO_DATA, GIORNO_SETTIMANA, NOME_VACANZE, ORARIO, TAC
FROM CALENDARI 
WHERE TAC IS NULL AND NOME_VACANZE IS NULL AND GIORNO_SETTIMANA <> 'Domenica' 
ORDER BY CALENDARIO_DATA LIMIT 0, 200;

CREATE VIEW CALENDARIO_RISONANZA_MAGNETICA
AS SELECT CALENDARIO_DATA, GIORNO_SETTIMANA, NOME_VACANZE, ORARIO, RISONANZA_MAGNETICA
FROM CALENDARI 
WHERE RISONANZA_MAGNETICA IS NULL AND NOME_VACANZE IS NULL AND GIORNO_SETTIMANA <> 'Domenica' 
ORDER BY CALENDARIO_DATA LIMIT 0, 200;

CREATE VIEW CALENDARIO_CHEMIOTERAPIA
AS SELECT CALENDARIO_DATA, GIORNO_SETTIMANA, NOME_VACANZE, ORARIO, CHEMIOTERAPIA
FROM CALENDARI 
WHERE CHEMIOTERAPIA IS NULL AND NOME_VACANZE IS NULL AND GIORNO_SETTIMANA <> 'Domenica' 
ORDER BY CALENDARIO_DATA LIMIT 0, 200;

CREATE VIEW CALENDARIO_RADIOTERAPIA
AS SELECT CALENDARIO_DATA, GIORNO_SETTIMANA, NOME_VACANZE, ORARIO, RADIOTERAPIA
FROM CALENDARI 
WHERE RADIOTERAPIA IS NULL AND NOME_VACANZE IS NULL AND GIORNO_SETTIMANA <> 'Domenica' 
ORDER BY CALENDARIO_DATA LIMIT 0, 200;
