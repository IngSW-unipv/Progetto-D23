...
CREATE TABLE CALENDARI (
    ...
    ID_PREN_1 SMALLINT,		--  VISITA_ONCOLOGICA
    ID_PREN_2 SMALLINT,		-- 	VISITA_PSICOLOGICA
    ID_PREN_3 SMALLINT,		-- 	ESAME_SANGUE
    ID_PREN_4 SMALLINT,		-- 	TAC
    ID_PREN_5 SMALLINT,		-- 	RISONANZA_MAGNETICA
    ID_PREN_6 SMALLINT,		-- 	CHEMIOTERAPIA
    ID_PREN_7 SMALLINT,		-- 	RADIOTERAPIA
    ID_PREN_8 SMALLINT,		-- 	OPERAZIONE
	-- FOREIGN KEY(ID_STR) REFERENCES STRUTTURE_SANITARIE(ID_STR),
